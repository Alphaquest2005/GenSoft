...
namespace EventMessages.Commands
{
    ...
    public class LoadEntitySetWithFilterWithIncludes : ProcessSystemMessage, ILoadEntitySetWithFilterWithIncludes
    {
        ...
        public LoadEntitySetWithFilterWithIncludes(IDynamicEntityType entityType,List<Expression<Func<IDynamicEntity,bool>>> filter, List<Expression<Func<IDynamicEntity, dynamic>>> includes, IStateCommandInfo processInfo, ISystemProcess process, ISystemSource source) : base(processInfo,process, source)
        {
