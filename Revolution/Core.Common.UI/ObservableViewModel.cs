...
namespace Core.Common.UI
{
    ...
    public partial class ObservableViewModel<TEntity> : BaseViewModel<ObservableViewModel<TEntity>>,
        IEntityViewModel<TEntity> where TEntity : IEntityId
    {
        ...
        private ReactiveProperty<IProcessState<TEntity>> _state =
            new ReactiveProperty<IProcessState<TEntity>>(null, ReactivePropertyMode.DistinctUntilChanged);
        ...
        {
            if (State.Value.Entity.GetType().GetProperty(property,
                    BindingFlags.Public | BindingFlags.SetProperty | BindingFlags.Instance) == null) return;
        ...
        public ObservableDictionary<string, dynamic> ChangeTracking { get; } =
            new ObservableDictionary<string, dynamic>();
