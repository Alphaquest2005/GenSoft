...
namespace RevolutionData.Context
{
    public class Actor
    {
        public class Commands
        {
            ...
            public static IStateCommand CreateActor => new StateCommand("CreateService", "Create Actor Service", "Actor", "Unknown", Events.ActorCreated);

        }
        public class Events
        {
            public static IStateEvent ActionCreated => new StateEvent("ActionCreated", "Action Created", "", "Action", "Unknown");
            ...
            public static IStateEvent ActorCreated => new StateEvent("ActorCreated", "Actor Created", "", "Actor", "Unknown");
        }
    }
}
