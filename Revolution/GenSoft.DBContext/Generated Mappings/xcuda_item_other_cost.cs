...
{
	public class xcuda_item_other_costMap
	{
		public static void Map(EntityTypeBuilder<Entities.xcuda_item_other_cost> entityBuilder)
		{
			entityBuilder.ToTable("xcuda_item_other_cost", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.xcuda_Valuation_item xcuda_Valuation_item).WithOne(p => p.xcuda_item_other_cost).HasForeignKey<xcuda_Valuation_item>(c => c.Valuation_item_Id).OnDelete(DeleteBehavior.Restrict);
