...
{
	public class ComplexEventActionExpectedEventsMap
	{
		public static void Map(EntityTypeBuilder<Entities.ComplexEventActionExpectedEvents> entityBuilder)
		{
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//entityBuilder.HasOne(p => p.ExpectedEvents ExpectedEvents).WithMany(p => p.ComplexEventActionExpectedEvents).HasForeignKey(c => c.ExpectedEventId).OnDelete(DeleteBehavior.Restrict);
