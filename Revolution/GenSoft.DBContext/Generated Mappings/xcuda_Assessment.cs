...
{
	public class xcuda_AssessmentMap
	{
		public static void Map(EntityTypeBuilder<Entities.xcuda_Assessment> entityBuilder)
		{
			entityBuilder.ToTable("xcuda_Assessment", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.xcuda_Identification xcuda_Identification).WithOne(p => p.xcuda_Assessment).HasForeignKey<xcuda_Identification>(c => c.ASYCUDA_Id).OnDelete(DeleteBehavior.Restrict);
