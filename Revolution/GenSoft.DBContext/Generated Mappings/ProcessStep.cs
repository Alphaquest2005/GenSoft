...
namespace GenSoft.Mappings
{
	public class ProcessStepMap
	{
		...
		//-------------------Navigation Properties -------------------------------//
				...
				entityBuilder.HasMany(x => x.NextProcessSteps).WithOne(p => p.NextProcessStep).HasForeignKey(c => c.NextProcessStepId).OnDelete(DeleteBehavior.Restrict);
				entityBuilder.HasMany(x => x.ProcessSteps).WithOne(p => p.ProcessStep).HasForeignKey(c => c.ProcessStepId).OnDelete(DeleteBehavior.Restrict);
