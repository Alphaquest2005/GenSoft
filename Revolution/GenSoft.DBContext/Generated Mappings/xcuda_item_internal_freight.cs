...
{
	public class xcuda_item_internal_freightMap
	{
		public static void Map(EntityTypeBuilder<Entities.xcuda_item_internal_freight> entityBuilder)
		{
			entityBuilder.ToTable("xcuda_item_internal_freight", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.xcuda_Valuation_item xcuda_Valuation_item).WithOne(p => p.xcuda_item_internal_freight).HasForeignKey<xcuda_Valuation_item>(c => c.Valuation_item_Id).OnDelete(DeleteBehavior.Restrict);
