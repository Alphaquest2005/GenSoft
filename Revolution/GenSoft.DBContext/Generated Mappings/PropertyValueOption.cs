...
namespace GenSoft.Mappings
{
	public class PropertyValueOptionMap
	{
		...
		{
			entityBuilder.ToTable("PropertyValueOptions", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//entityBuilder.HasOne(p => p.ViewPropertyValueOption ViewPropertyValueOption).WithMany(p => p.PropertyValueOptions).HasForeignKey(c => c.ValueOptionId).OnDelete(DeleteBehavior.Restrict);
