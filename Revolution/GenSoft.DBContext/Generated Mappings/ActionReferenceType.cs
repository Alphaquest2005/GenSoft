...
{
	public class ActionReferenceTypeMap
	{
		public static void Map(EntityTypeBuilder<Entities.ActionReferenceType> entityBuilder)
		{
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//entityBuilder.HasOne(p => p.ReferenceType ReferenceType).WithMany(p => p.ActionReferenceTypes).HasForeignKey(c => c.ReferenceTypeId).OnDelete(DeleteBehavior.Restrict);
