...
{
	public class xcuda_Gs_external_freightMap
	{
		public static void Map(EntityTypeBuilder<Entities.xcuda_Gs_external_freight> entityBuilder)
		{
			entityBuilder.ToTable("xcuda_Gs_external_freight", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.xcuda_Valuation xcuda_Valuation).WithOne(p => p.xcuda_Gs_external_freight).HasForeignKey<xcuda_Valuation>(c => c.Valuation_Id).OnDelete(DeleteBehavior.Restrict);
