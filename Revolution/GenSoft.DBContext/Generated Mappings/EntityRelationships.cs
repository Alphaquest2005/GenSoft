...
namespace GenSoft.Mappings
{
	public class EntityRelationshipsMap
	{
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.EntityId ParentEntity).WithMany(p => p.EntityRelationships).HasForeignKey(c => c.ParentEntityId).OnDelete(DeleteBehavior.Restrict);
				//entityBuilder.HasOne(p => p.EntityId ChildEntity).WithMany(p => p.EntityRelationships).HasForeignKey(c => c.ChildEntityId).OnDelete(DeleteBehavior.Restrict);
