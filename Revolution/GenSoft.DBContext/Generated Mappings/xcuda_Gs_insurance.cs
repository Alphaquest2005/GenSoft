...
{
	public class xcuda_Gs_insuranceMap
	{
		public static void Map(EntityTypeBuilder<Entities.xcuda_Gs_insurance> entityBuilder)
		{
			entityBuilder.ToTable("xcuda_Gs_insurance", "dbo");
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//----------------Parent Properties
				//entityBuilder.HasOne(p => p.xcuda_Valuation xcuda_Valuation).WithOne(p => p.xcuda_Gs_insurance).HasForeignKey<xcuda_Valuation>(c => c.Valuation_Id).OnDelete(DeleteBehavior.Restrict);
