...
namespace GenSoft.Mappings
{
	public class EntityTypeViewModelMap
	{
		...
		//-------------------Navigation Properties -------------------------------//
				...
				entityBuilder.HasMany(x => x.ChildViewModels).WithOne(p => p.ChildViewModel).HasForeignKey(c => c.ChildViewModelId).OnDelete(DeleteBehavior.Restrict);
				entityBuilder.HasMany(x => x.ParentViewModels).WithOne(p => p.ParentViewModel).HasForeignKey(c => c.ParentViewModelId).OnDelete(DeleteBehavior.Restrict);
