...
namespace GenSoft.Mappings
{
	public class EntityTypeViewModelMap
	{
		public static void Map(EntityTypeBuilder<Entities.EntityTypeViewModel> entityBuilder)
		{
			...
			entityBuilder.Property(t => t.ViewModelId).HasColumnName("ViewModelId").IsRequired();
		...
		//-------------------Navigation Properties -------------------------------//
				...
				//entityBuilder.HasOne(p => p.ViewModelTypes ViewModelTypes).WithMany(p => p.EntityTypeViewModel).HasForeignKey(c => c.ViewModelId).OnDelete(DeleteBehavior.Restrict);
