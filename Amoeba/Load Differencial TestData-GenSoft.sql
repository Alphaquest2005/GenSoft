...
FOR 
SELECT DISTINCT Id 
FROM AmoebaDB.dbo.Entities where Name = @UpdateTable and (id in (SELECT DISTINCT  ApplicationEntities.EntityId
...
delete from AmoebaDB.dbo.TestValues where EntityPropertyId in (SELECT        EntityProperties.Id
																FROM            AmoebaDB.dbo.Entities INNER JOIN
																						 AmoebaDB.dbo.EntityProperties ON Entities.Id = EntityProperties.EntityId
